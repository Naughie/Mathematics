...
\newcommand{\roma}[1]{{\fontfamily{lmr}\selectfont #1}}
\else\ifluatex
...
\newcommand{\empha}[1]{{\setmainfont[Ligatures=TeX]{TeXGyreTermes}\textbf{\textit{#1}}}}
\newcommand{\roma}[1]{{\setmainfont[Ligatures=TeX]{Latin Modern Roman} #1\relax}}
\fi
\fi
