...
\subsubsection{Maximal Atlas on a locally Euclidean space [Definition \ref{maximal-atlas-on-a-locally-euclidean-space}]}\label{maximal-atlas-on-a-locally-euclidean-space}
An atlas $\g M$ on a locally Euclidean space is \EMPH{maximal} if for another atlas $\g U$, $\g M \subset \g U$ implies $\g M = \g U$.

\subsubsection{Smooth manifold [Definition \ref{smooth-manifold}]}\label{smooth-manifold}
...
\subsubsection{A locally Euclidean space with an atlas has a maximal atlas [Proposition \ref{a-locally-euclidean-space-with-an-atlas-has-a-maximal-atlas}]}\label{a-locally-euclidean-space-with-an-atlas-has-a-maximal-atlas}
In a locally Euclidean space, any atlas is contained in a unique maximal atlas.

\subsubsection{Conventions of manifold [Definition \ref{convections-of-manifold}]}\label{convections-of-manifold}
\begin{enumerate}
...
\subsubsection{Product manifold [Proposition \ref{product-manifold}]}\label{product-manifold}
For a $m$-manifold $M$ and $n$-manifold $N$, and charts $\{(U_\alpha,\phi_\alpha)\}$ of $M$ and $\{(V_{\alpha'},\psi_{\alpha'})\}$ of $N$, the collection
\begin{align*}
