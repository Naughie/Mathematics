...
\subsubsection{Absolute values on a field of rational functions [Definition \ref{absolute-values-on-a-field-of-rational-functions}]}\label{absolute-values-on-a-field-of-rational-functions}
...
\subsubsection{Properties of absolute values on fields [Lemma \ref{properties-of-absolute-values-on-fields}]}\label{properties-of-absolute-values-on-fields}
...
\subsubsection{Necessary and sufficient conditions of a non-archimedean absolute value [Theorem \ref{necessary-and-sufficient-conditions-of-a-non-archimedean-absolute-value}]}\label{necessary-and-sufficient-conditions-of-a-non-archimedean-absolute-value}
